...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-sp6pit74f9e">Show
  modal</button>

<div data-modal id="modal-sp6pit74f9e" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-sp6pit74f9e-label" aria-describedby="modal-sp6pit74f9e-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-sp6pit74f9e-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-sp6pit74f9e-heading">Modal heading</p>
