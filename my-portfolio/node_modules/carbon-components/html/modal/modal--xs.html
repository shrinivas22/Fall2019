...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-24x7qd5pf0a">Show
  modal</button>

<div data-modal id="modal-24x7qd5pf0a" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-24x7qd5pf0a-label" aria-describedby="modal-24x7qd5pf0a-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-24x7qd5pf0a-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-24x7qd5pf0a-heading">Modal heading</p>
