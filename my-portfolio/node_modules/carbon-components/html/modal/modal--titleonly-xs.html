...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ho4qpmcahyr">Show
  modal</button>

<div data-modal id="modal-ho4qpmcahyr" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ho4qpmcahyr-label" aria-describedby="modal-ho4qpmcahyr-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ho4qpmcahyr-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ho4qpmcahyr-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
