...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-r4k24bvmosi">Show
  modal</button>

<div data-modal id="modal-r4k24bvmosi" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-r4k24bvmosi-label" aria-describedby="modal-r4k24bvmosi-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-r4k24bvmosi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-r4k24bvmosi-heading">Modal heading</p>
