...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-fpup7d37oyn">Show
  modal</button>

<div data-modal id="modal-fpup7d37oyn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-fpup7d37oyn-label" aria-describedby="modal-fpup7d37oyn-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-fpup7d37oyn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-fpup7d37oyn-heading">Modal heading</p>
