...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-bb87tdkii7">Show
  modal</button>

<div data-modal id="modal-bb87tdkii7" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-bb87tdkii7-label" aria-describedby="modal-bb87tdkii7-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-bb87tdkii7-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-bb87tdkii7-heading">Modal heading</p>
