...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-etptqi5lv">Show
  modal</button>

<div data-modal id="modal-etptqi5lv" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-etptqi5lv-label" aria-describedby="modal-etptqi5lv-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-etptqi5lv-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-etptqi5lv-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-etptqi5lv" class="bx--label">Text Input label</label>
        <input id="text-input-etptqi5lv" type="text" class="bx--text-input" placeholder="Optional placeholder text"
