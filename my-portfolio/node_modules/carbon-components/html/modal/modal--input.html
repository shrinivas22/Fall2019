...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-f15oikikbx5">Show
  modal</button>

<div data-modal id="modal-f15oikikbx5" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-f15oikikbx5-label" aria-describedby="modal-f15oikikbx5-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-f15oikikbx5-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-f15oikikbx5-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-f15oikikbx5" class="bx--label">Text Input label</label>
        <input id="text-input-f15oikikbx5" type="text" class="bx--text-input" placeholder="Optional placeholder text"
