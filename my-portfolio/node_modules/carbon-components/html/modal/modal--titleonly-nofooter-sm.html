...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-tqmmwipjtk8">Show
  modal</button>

<div data-modal id="modal-tqmmwipjtk8" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-tqmmwipjtk8-label" aria-describedby="modal-tqmmwipjtk8-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-tqmmwipjtk8-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-tqmmwipjtk8-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
