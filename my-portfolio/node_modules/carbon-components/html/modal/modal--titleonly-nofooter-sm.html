...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-02n5yxesx9it">Show
  modal</button>

<div data-modal id="modal-02n5yxesx9it" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-02n5yxesx9it-label" aria-describedby="modal-02n5yxesx9it-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-02n5yxesx9it-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-02n5yxesx9it-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
