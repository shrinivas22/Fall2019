...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-dbr2q20sntd">Show
  modal</button>

<div data-modal id="modal-dbr2q20sntd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-dbr2q20sntd-label" aria-describedby="modal-dbr2q20sntd-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-dbr2q20sntd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-dbr2q20sntd-heading">Modal heading</p>
