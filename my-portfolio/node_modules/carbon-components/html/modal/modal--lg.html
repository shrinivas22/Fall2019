...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-etirskm7gmf">Show
  modal</button>

<div data-modal id="modal-etirskm7gmf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-etirskm7gmf-label" aria-describedby="modal-etirskm7gmf-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-etirskm7gmf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-etirskm7gmf-heading">Modal heading</p>
