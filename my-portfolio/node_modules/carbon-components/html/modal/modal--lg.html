...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-awcjtx3l1vs">Show
  modal</button>

<div data-modal id="modal-awcjtx3l1vs" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-awcjtx3l1vs-label" aria-describedby="modal-awcjtx3l1vs-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-awcjtx3l1vs-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-awcjtx3l1vs-heading">Modal heading</p>
