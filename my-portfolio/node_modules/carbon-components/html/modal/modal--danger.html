...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-bwb1yyl522r">Show
  modal</button>

<div data-modal id="modal-bwb1yyl522r" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-bwb1yyl522r-label" aria-describedby="modal-bwb1yyl522r-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-bwb1yyl522r-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-bwb1yyl522r-heading">Modal heading</p>
