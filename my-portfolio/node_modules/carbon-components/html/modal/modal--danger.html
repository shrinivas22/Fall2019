...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-3jkqo1t8m4h">Show
  modal</button>

<div data-modal id="modal-3jkqo1t8m4h" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-3jkqo1t8m4h-label" aria-describedby="modal-3jkqo1t8m4h-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-3jkqo1t8m4h-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-3jkqo1t8m4h-heading">Modal heading</p>
