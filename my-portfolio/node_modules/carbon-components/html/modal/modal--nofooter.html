...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mui9hp7ovn">Show
  modal</button>

<div data-modal id="modal-mui9hp7ovn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-mui9hp7ovn-label" aria-describedby="modal-mui9hp7ovn-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mui9hp7ovn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mui9hp7ovn-heading">Modal heading</p>
