...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-splppgmrej">Show
  modal</button>

<div data-modal id="modal-splppgmrej" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-splppgmrej-label" aria-describedby="modal-splppgmrej-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-splppgmrej-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-splppgmrej-heading">Modal heading</p>
