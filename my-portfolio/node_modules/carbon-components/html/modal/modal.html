...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-insvc45nkb">Show
  modal</button>

<div data-modal id="modal-insvc45nkb" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-insvc45nkb-label" aria-describedby="modal-insvc45nkb-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-insvc45nkb-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-insvc45nkb-heading">Modal heading</p>
