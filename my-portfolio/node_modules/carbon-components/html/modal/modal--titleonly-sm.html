...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ftc0ocku9kv">Show
  modal</button>

<div data-modal id="modal-ftc0ocku9kv" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ftc0ocku9kv-label" aria-describedby="modal-ftc0ocku9kv-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ftc0ocku9kv-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ftc0ocku9kv-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
