...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-hbse4r3asr5">Show
  modal</button>

<div data-modal id="modal-hbse4r3asr5" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-hbse4r3asr5-label" aria-describedby="modal-hbse4r3asr5-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-hbse4r3asr5-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-hbse4r3asr5-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
