...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-h2asli5tebd">Show
  modal</button>

<div data-modal id="modal-h2asli5tebd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-h2asli5tebd-label" aria-describedby="modal-h2asli5tebd-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-h2asli5tebd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-h2asli5tebd-heading">Modal heading</p>
