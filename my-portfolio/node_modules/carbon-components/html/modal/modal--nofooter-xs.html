...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-82jlopulr87">Show
  modal</button>

<div data-modal id="modal-82jlopulr87" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-82jlopulr87-label" aria-describedby="modal-82jlopulr87-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-82jlopulr87-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-82jlopulr87-heading">Modal heading</p>
