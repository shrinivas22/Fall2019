...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-d9zkkeapo2m">Show
  modal</button>

<div data-modal id="modal-d9zkkeapo2m" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-d9zkkeapo2m-label" aria-describedby="modal-d9zkkeapo2m-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-d9zkkeapo2m-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-d9zkkeapo2m-heading">Modal heading</p>
