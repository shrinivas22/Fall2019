...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-7do1e1j715c">Show
  modal</button>

<div data-modal id="modal-7do1e1j715c" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-7do1e1j715c-label" aria-describedby="modal-7do1e1j715c-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-7do1e1j715c-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-7do1e1j715c-heading">Modal heading</p>
