...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-yrb59r2spmg">Show
  modal</button>

<div data-modal id="modal-yrb59r2spmg" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-yrb59r2spmg-label" aria-describedby="modal-yrb59r2spmg-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-yrb59r2spmg-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-yrb59r2spmg-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
