...
ToggleSmall.propTypes = (_ToggleSmall$propType = {}, _defineProperty(_ToggleSmall$propType, 'aria-label', _propTypes.default.string.isRequired), _defineProperty(_ToggleSmall$propType, "className", _propTypes.default.string), _defineProperty(_ToggleSmall$propType, "defaultToggled", _propTypes.default.bool), _defineProperty(_ToggleSmall$propType, "id", _propTypes.default.string.isRequired), _defineProperty(_ToggleSmall$propType, "labelA", _propTypes.default.string.isRequired), _defineProperty(_ToggleSmall$propType, "labelB", _propTypes.default.string.isRequired), _defineProperty(_ToggleSmall$propType, "labelText", _propTypes.default.string), _defineProperty(_ToggleSmall$propType, "onChange", _propTypes.default.func), _defineProperty(_ToggleSmall$propType, "onToggle", _propTypes.default.func), _defineProperty(_ToggleSmall$propType, "toggled", _propTypes.default.bool), _ToggleSmall$propType);
